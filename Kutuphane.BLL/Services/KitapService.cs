...
namespace Kutuphane.BLL.Services
{
    ...
    {
        //private readonly IKitapDal<KitapDal> _repository;
        ...
        //{
        //    return _repository.GetByFilter(id);
        //}
        ...
        //    return _repository.GetListByFilter(k =>
        ...
        //    var mevcutKitap = _repository.GetListByFilter(k => k.ISBN == kitap.ISBN);
        //    if (mevcutKitap != null)
        ...
        //    var mevcut = _repository.GetByFilter(kitap.KitapID);
        ...
        //    var kitap = _repository.GetByFilter(id);
        //    if (kitap == null)
        ...
        //{
        //    var kitap = _repository.GetByFilter(kitapId);
        //    if (kitap == null)
        //        return new ServiceResult { Basarili = false, Mesaj = "Kitap bulunamadı." };
