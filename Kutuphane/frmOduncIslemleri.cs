...
namespace Kutuphane.UI
{
    public partial class frmOduncIslemleri : Form
    {
        ...
        //    _kitapService = new KitapService(new EfRepositoryBase<Kitap>());
        //    _uyeService = new UyeService(new EfRepositoryBase<Uye>());
        //    _oduncService = new OduncService(new EfRepositoryBase<Odunc>(), _kitapService);
        //}
